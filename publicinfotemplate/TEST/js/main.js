...
function(
    ...
    return declare("", [About, SocialLayers], {
        ...
        _createGeocoderOptions: function() {
		  ...
		  var locatorUrl1 = "http://mdimap.us/ArcGIS/rest/services/GeocodeServices/MD.State.MDCascadingLocatorWithoutZIPCodes/GeocodeServer";
            ...
            if(geocoders.length){
                ...
                array.forEach(geocoders, lang.hitch(this, function(geocoder) {
                    ...
                    if (geocoder.url && geocoder.url.indexOf(".arcgis.com/arcgis/rest/services/World/GeocodeServer") > -1) {
                        ...
                        geocoder.placeholder = "Find a location";
                    }
					
					//if not esri geocoder
					   if (geocoder.url && geocoder.url.indexOf("http://mdimap.us/ArcGIS/rest/services/GeocodeServices/MD.State.MDCascadingLocatorWithoutZIPCodes/GeocodeServer") > -2) {
                        hasEsri = false;
                        geocoder.name = "MD Test";
		...
		//CODE ADDED TO GEOCODER POINTER - START
		
		
		
		// CODE ADDED TO ADD GEOCODER POINTER -END
